...
public class ClientRequestDTO {
    ...
    //Há alguns atributos que não devem ter setter, mudar isso depois
    public ClientRequestDTO() {
    }
    public ClientRequestDTO(String name, Long cpf, LocalDate dateOfBirth, String email, String password) {
        this.name = name;
        this.cpf = cpf;
