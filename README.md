...
**Descrição:** A Versão 1.2.0 Conta com pontos fortes sobre o tratamento de dados e a organização do código, onde o foco foi melhorar a estrutura do projeto,
